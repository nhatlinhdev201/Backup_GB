...
const lineCurved = (iPosition, height, circle) => {
  ...
  const curved = shape.line().x(d => d.x).y(d => d.y).curve(shape.curveBasis)([{
    x: position - (0, _reactNativeSizeScaling.scale)(20),
    y: 0
  },
  // border center left
  {
    x: position - (0, _reactNativeSizeScaling.scale)(10),
    y: (0, _reactNativeSizeScaling.scale)(2)
  }, {
    x: position - (0, _reactNativeSizeScaling.scale)(2),
    y: (0, _reactNativeSizeScaling.scale)(10)
  }, {
    x: position,
    y: (0, _reactNativeSizeScaling.scale)(17)
  }, {
    x: trim - (0, _reactNativeSizeScaling.scale)(25),
    y: height / 2 + (0, _reactNativeSizeScaling.scale)(2)
  }, {
    x: trim - (0, _reactNativeSizeScaling.scale)(10),
    y: height / 2 + (0, _reactNativeSizeScaling.scale)(10)
  }, {
    x: trim,
    y: height / 2 + (0, _reactNativeSizeScaling.scale)(10)
  }, {
  ...
  // border center right
  {
    x: circleWidth + (0, _reactNativeSizeScaling.scale)(2),
    y: (0, _reactNativeSizeScaling.scale)(10)
  }, {
    x: circleWidth + (0, _reactNativeSizeScaling.scale)(10),
    y: 0
  }, {
    x: circleWidth + (0, _reactNativeSizeScaling.scale)(20),
    y: 0
  }]);
  return curved;
};
const getPathDown = function (width, iHeight, centerWidth) {
  ...
  const circleWidth = (0, _reactNativeSizeScaling.scale)(centerWidth) + (0, _reactNativeSizeScaling.scale)(16);
...
exports.getPathDown = getPathDown;
