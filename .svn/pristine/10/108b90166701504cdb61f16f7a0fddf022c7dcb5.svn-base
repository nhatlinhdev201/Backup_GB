...
const Button = ({ bgColor, btnMargin = 8, textColor = 'white', fontSize = 20, fontWeight = 'normal', textMargin = 20, disable = false, paddingHorizontal = 25, paddingVertical = 12, icon: Icon, children = 'default', onPress, ...props }) => {
